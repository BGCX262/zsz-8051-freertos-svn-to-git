...
//
//================================================================================================
// These files must be included before this header file
...
//------------------------------------------------------------------------------------------------
#ifndef  SYSCLK_KHZ
#define  SYSCLK_KHZ   (SYSCLK/1000L)
#endif
// New TIME_US() macro using SYSCLK_KHA for use with 24.5 Mhz innternal oscillator
#define TIMEOUT_US(n)      (((U32)(n)*SYSCLK_KHZ)/4000L)
#define BYTE_TIME(n)       ((SYSCLK/n)*8/4)
///------------------------------------------------------------------------------------------------
// Fixed Timeouts
//------------------------------------------------------------------------------------------------
// XTAL timeout 1.5ms
...
extern SEGMENT_VARIABLE(EZMacProTimerMSB, U8, EZMAC_PRO_GLOBAL_MSPACE);
...
extern SEGMENT_VARIABLE(TimeoutPreamble, U16, EZMAC_PRO_GLOBAL_MSPACE);
extern SEGMENT_VARIABLE(TimeoutSyncWord, U32, EZMAC_PRO_GLOBAL_MSPACE);
extern SEGMENT_VARIABLE(TimeoutHeader, U16, EZMAC_PRO_GLOBAL_MSPACE);
...
extern SEGMENT_VARIABLE(TimeoutChannelSearch, U16, EZMAC_PRO_GLOBAL_MSPACE);
...
MacParams EZMacPRO_TxBuf_Write(U8, VARIABLE_SEGMENT_POINTER(, U8, BUFFER_MSPACE));
MacParams EZMacPRO_RxBuf_Read(VARIABLE_SEGMENT_POINTER(, U8, BUFFER_MSPACE), VARIABLE_SEGMENT_POINTER(, U8, BUFFER_MSPACE));
